...
{ time LD_LIBRARY_PATH=$LD_LIBRARY_PATH:../libshoal/shoal/ ./streamcluster 10 20 128 1000000 200000 5000 none output.txt ${i}; } &>> res_baseline_last.txt
