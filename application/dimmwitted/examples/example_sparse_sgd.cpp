...
/*
  ...
  std::cout << "\n GLM DENSE SCD: PER MACHINE \n" << std::endl;

  std::cout << "DW_DATAREPL_SHARDING \n" << std::endl;
  rs = test_glm_dense_scd<DW_MODELREPL_PERMACHINE, DW_DATAREPL_SHARDING>();
  std::cout << "SUM OF MODEL: " << rs << "\n" << std::endl;

  std::cout << "DW_DATAREPL_FULL \n" << std::endl; 
  rs = test_glm_dense_scd<DW_MODELREPL_PERMACHINE, DW_DATAREPL_FULL>(); 
  std::cout << "SUM OF MODEL: " << rs << "\n" << std::endl; 

  std::cout << "\n GLM DENSE SCD: PER NODE \n" << std::endl;

  std::cout << "DW_DATAREPL_SHARDING \n" << std::endl;
  rs = test_glm_dense_scd<DW_MODELREPL_PERNODE, DW_DATAREPL_SHARDING>();
  std::cout << "SUM OF MODEL: " << rs << "\n" << std::endl;

  std::cout << "DW_DATAREPL_FULL \n" << std::endl; 
  rs = test_glm_dense_scd<DW_MODELREPL_PERNODE, DW_DATAREPL_FULL>();
  std::cout << "SUM OF MODEL: " << rs << "\n" << std::endl;

  std::cout << "\n GLM DENSE SCD: PER CORE \n" << std::endl;

  std::cout << "DW_DATAREPL_SHARDING \n" << std::endl;
  rs = test_glm_dense_scd<DW_MODELREPL_PERCORE, DW_DATAREPL_SHARDING>();
  std::cout << "SUM OF MODEL: " << rs << "\n" << std::endl;

  std::cout << "DW_DATAREPL_FULL \n" << std::endl;
  rs = test_glm_dense_scd<DW_MODELREPL_PERCORE, DW_DATAREPL_FULL>();
  std::cout << "SUM OF MODEL: " << rs << "\n" << std::endl;
