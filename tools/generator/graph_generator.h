...
// pack to divisor of CACHE_LINE_SIZE
typedef struct packed_edge {
  int32_t v0, v1;
  double data;
} packed_edge;
...
static inline void write_edge(packed_edge* p, int32_t v0, int32_t v1) {
  p->v0 = v0;
  p->v1 = v1;
  p->data = 0;
}
...
typedef Charm::GlobalAddress<packed_edge> edges_ptr_t;
#else
